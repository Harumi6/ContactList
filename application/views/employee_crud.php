...
$this->load->view('partials/header', ['page_title' => 'Employee Profile - ATTG Contact']);
?>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a href="<?= site_url('send_data') ?>" class="btn btn-secondary btn-sm mb-2 mt-1 mr-2"><i class="fas fa-eye"></i> ดูหน้าเว็บผู้ใช้ทั่วไป</a>
            </li>
            <li class="nav-item">
                ...
                <div class="card-body box-profile d-flex flex-column justify-content-center">
                  ...
                  <form id="employeeProfileForm" class="flex-grow-1 d-flex flex-column justify-content-between">
                    <div>
                      ...
                      <div class="form-group mb-2">
                        <label class="mb-1"><small><i class="fas fa-mobile-alt mr-1"></i> Mobile Phone (เบอร์มือถือ) <span class="text-danger">* ยินดีให้แสดงใน ContactList</span></small></label>
          ...
          success: function(res) {
            if (res.status === "success") {
              Swal.fire({
                icon: "success",
                title: "Success",
                text: res.message || "อัปเดตเรียบร้อย",
                timer: 1500,
